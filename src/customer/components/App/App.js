...
class App extends React.Component{
    ...
    _handleUsernameState = (usernameCookie) => {
        this.setState({
    ...
    _handleCoffeeShopDummyState =  (shops) => {
        this.setState({
            shops: shops
        }, this._getShopsCoordinates)
    }
    ...
    _handleSelectedShopDetails =(place) => {
        this.setState({
            selectedShop: place
        })
    ...
    _handleSelectedShopLocation = (place) => {
        this.setState({
            selectedShopLocation: {
    ...
    _handleDistanceAndDuration = (response) => {
        this.setState({
    ...
    _toggleAdditionalInfoNotification= () => {
        this.setState({
            notification: {
                additionalInfo: true
            }
    ...
    _handleAddItemToOrder= (itemDetails) =>{
        this.setState({
            items: this.state.items.concat(itemDetails),
        });
    }

    _handleDeleteItemFromOrder= (index)=> {
